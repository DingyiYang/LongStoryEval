...
def preprocess(
        ...
        system_message: str = "You are a helpful assistant for story evaluation."
) -> Dict:
...
def train():
    ...
    #print("Train DataLoader shuffle:", trainer.get_train_dataloader().shuffle)
    # 获取训练 DataLoader
    ...
    if hasattr(train_dataloader, "sampler"):
        ...
        print("Cannot determine shuffle status (sampler not found).")
        #check_the_pre_points
